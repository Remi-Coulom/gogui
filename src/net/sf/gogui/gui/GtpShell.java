    ...
    implements ActionListener, GtpClient.IOCallback
{
    ...
    {
        void actionToggleShowAnalyzeDialog();
    ...
    public void actionPerformed(ActionEvent event)
    {
        ...
        if (command.equals("analyze"))
            m_listener.actionToggleShowAnalyzeDialog();
    ...
    */
    public boolean send(String command, Component owner, boolean askContinue)
    {
        ...
        else
        {
            ...
            try
            {
                m_listener.sendGtpCommand(command, owner != null);
            }
            catch (GtpError e)
            {
                GuiGtpUtil.showError(owner, m_programName, e);
                if (askContinue)
